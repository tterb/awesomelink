...
$(document).ready(function(){
    ...
    function updateRating(evt) {
        ...
        // var emojiOffset = (-7.5 * ratingValue);
        // ratingEmoji.offsetParent.setAttribute('style', 'transform: translateY(' + emojiOffset + 'rem)');
        // Update rating stars
    ...
    shareBtn.on('click', toggleShareModal);
