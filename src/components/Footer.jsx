...
const Footer = () => {
    return (
        <div className='flex flex-col md:flex-row bg-indigo-100 align-middle items-center w-screen h-auto min-h-48 py-10 px-0'>
            <div className='flex flex-col md:flex-row align-middle items-center w-9/10 md:w-5/6 lg:4/5 max-w-250 mx-auto'>
                <Link
